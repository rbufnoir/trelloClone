    ...
    <section class="d-flex align-items-start h-100" style="position: relative">
        <div id="lists" class="d-flex align-items-start">
            ...
            <?php 
                ...
                <div id="<?= $url[1] .'/'. $url[2] . '/' . $list->getId(); ?>" class="card shadow-1-strong m-3 p-2 pb-0 list">
                    ...
                    <div class="card-footer border-0 pt-0">
                        <button type="button" class="btn btn-link btn-block text-reset" data-bs-whatever="list" data-bs-info="<?= $url[1] .'/'. $url[2] . '/' . $list->getId(); ?>">
